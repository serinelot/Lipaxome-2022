setwd("C:/Users/serin/OneDrive - USherbrooke/1- UdeS/1-Maîtrise/RNA_chol_gene_asd/Dataset Geo_Omnibus/GSE102741")
...
chol.string <- read.csv("C:/Users/serin/OneDrive - USherbrooke/1- UdeS/1-Maîtrise/RNA_chol_gene_asd/Set de gènes/chol_set_gene.csv"
                        , header = TRUE)
